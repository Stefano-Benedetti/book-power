...
@export var float_height: float = 4.0      # quanto sale/scende
@export var float_speed: float = 3.0        # velocità oscillazione
@export var shadow_scale_min: float = 0.9   # ombra più piccola (quando oggetto è alto)
@export var shadow_scale_max: float = 1.15   # ombra più grande (quando oggetto è basso)
